                            ...
                            <AnimatedList
                              items={ability.map((template: any) => (
                                ...
                                >
                                  ...
                                  {selectedTemplateIds.includes(template.id) ? (
                                    <Button variant="outline" className="flex items-center px-3 py-1 text-primary">
                                      <CheckIcon className="w-4 h-4 mr-1 text-secondary" />
                                      <span className="text-secondary text-md">Selected</span>
                                    </Button>
                                  ) : (
                                    <Button
                                      className="w-fit flex items-center gap-1"
                                      onClick={() => add(template.desc, template.id)}
                                    >
                                      <span>Input</span>
                                    </Button>
                                  )}
